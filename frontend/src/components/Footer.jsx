    ...
    <footer className="footer-custom">
      <div className="container">
        <div className="row gy-5">
          ...
          <div className="col-12 col-lg-3 footer-col brand-col">
            <div className="footer-logo-wrap">
              <img src="/assets/sarry-logo.png" alt="Logo" className="footer-brand-logo" onError={(e) => { e.target.style.display = 'none'; }} />
            </div>
            <p className="footer-desc">
              <strong>Vastrudayam</strong> — Bengaluru's premier destination for luxury handloom sarees. Every drape tells a story of beauty and tradition, crafted to celebrate your grace. <br /><br />
              <em>Pure silk. Pure elegance.</em>
            </p>
          </div>
          ...
          <div className="col-12 col-lg-4 footer-col contact-col">
            ...
            <ul className="footer-contact-list">
              <li><strong>Phone:</strong> +91 9019397278  / +917993971574</li>
              <li><strong>Email:</strong> vastrudayamofficial@gmail.com</li>
            ...
            <div className="footer-social-icons">
              ...
              <a href="https://www.instagram.com/vastrudayam?igsh=b293OXJ0aXh6Y24=" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-icon ig"><i className="bi bi-instagram"></i></a>
        ...
        <div className="footer-bottom-row">
          <a href="https://wa.me/9113657841" target="_blank" rel="noopener noreferrer" className="whatsapp-enquire-btn">
        ...
        <div className="footer-copyright">
          &copy; 2026 Vastrudayam. All rights reserved.
          <div className="developer-credit">
            Developed and Maintained by <a href="https://www.zorvixetechnologies.com/" target="_blank" rel="noopener noreferrer">ZorvixeTechnologies</a>
          </div>
        </div>
      </div>
    </footer>
